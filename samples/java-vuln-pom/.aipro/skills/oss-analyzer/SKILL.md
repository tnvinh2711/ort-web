---
name: oss-analyzer
description: Use this skill PROACTIVELY when the user asks to scan, analyze, or audit a project for open-source dependencies, licenses, vulnerabilities, SBOM, or compliance using ORT. Runs ORT end-to-end, produces Markdown + Excel reports, and gives license/vuln suggestions grounded in oss-knowledge-base. Auto-trigger on keywords: analyze OSS, scan dependencies, license audit, SBOM, vulnerability scan, ORT, phan tich ma nguon mo, phan tich OSS, kiem tra license, quet dependency.
agents: [aipro]
---
